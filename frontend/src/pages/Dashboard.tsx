            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="relative">
                <select
                  ...
                  className="text-xs pl-2 pr-6 py-1.5 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500 appearance-none cursor-pointer font-medium"
                >
              ...
              {(perfFilter.division || perfFilter.department || perfFilter.unit || perfFilter.job_title || perfFilter.quarter) && (
                <button
                  ...
                  className="text-xs px-2 py-1.5 rounded-lg text-brand-500 hover:bg-brand-50 dark:hover:bg-brand-800/20 font-medium transition-colors"
                >
                  Reset
                </button>
              )}
